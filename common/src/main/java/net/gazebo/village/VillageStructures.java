...
/// injector stays null and the gazebo is only placed through the data-driven paths that ship in
/// `resources/data/gazebo` (Lithostitched worldgen modifiers, Repurposed Structures pool additions).
